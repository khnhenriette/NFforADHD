/*
The selection logging of the individual game objects in the Autumn scene 
...
public class ERPSelectionLoggerAutumn : MonoBehaviour
{
    private ERPGroupControllerAutumn groupController;
    ...
    void Awake()
    {
        ...
        groupController = GetComponentInParent<ERPGroupControllerAutumn>();
    }
    ...
    public void LogSelection()
    {
        ...
        ERPGameLoggerAutumn.Instance?.Log(fullName);
