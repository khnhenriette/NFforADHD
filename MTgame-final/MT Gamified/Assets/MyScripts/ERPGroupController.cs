/*
A script to control the behavior of the ERP groups (all with 4 ERP Tags) in the Winter scene
...
public class ERPGroupController : MonoBehaviour
{
    ...
    public WinterERPDeActivation deactivationTrigger;
    public BCIStepTrigger stepTrigger;
