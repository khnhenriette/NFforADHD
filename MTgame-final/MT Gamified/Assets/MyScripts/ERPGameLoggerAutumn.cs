...
public class ERPGameLoggerAutumn : MonoBehaviour
{
    public static ERPGameLoggerAutumn Instance { get; private set; }

    private string filePath;
    private string folderPath = @"C:\Users\student\Documents\Henriette\ERPLogsAutumn";
