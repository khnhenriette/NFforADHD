/*
A script to control the behavior of the ERP groups (all with 4 ERP Tags) in the Autumn scene 
...
public class ERPGroupControllerAutumn : MonoBehaviour
{
    ...
    public MushroomStepAdvance deactivationTrigger; // change activations of respecitve tags and sprites
    ...
    private void FireTriggers()
    {
        if (deactivationTrigger != null)
            deactivationTrigger.OnBCISelected();
    }
}
